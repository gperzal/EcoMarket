...
const FeaturedProducts = () => {
  ...
  const products = [
    {
      id: 1,
      name: "Botella Térmica Ecológica 750ml Acero Inoxidable",
      price: 12990,
      originalPrice: 15290,
      image: "/placeholder.svg?height=180&width=180&text=Botella+Térmica",
      discount: 15,
      installments: 6,
      freeShipping: true,
      rating: 4,
    ...
    {
      id: 2,
      name: "Set de Cubiertos Bambú Biodegradables x4 Unidades",
      price: 8500,
      originalPrice: 9440,
      image: "/placeholder.svg?height=180&width=180&text=Cubiertos+Bambú",
      discount: 10,
      installments: 3,
      freeShipping: true,
      rating: 5,
    ...
    {
      id: 3,
      name: "Bolsas Reutilizables Algodón Orgánico Pack x5",
      price: 5990,
      originalPrice: null,
      image: "/placeholder.svg?height=180&width=180&text=Bolsas+Reutilizables",
      discount: 0,
      installments: 3,
      freeShipping: false,
      rating: 4,
    ...
    {
      id: 4,
      name: "Cepillo Dental Bambú Biodegradable Pack Familiar",
      price: 7490,
      originalPrice: 9360,
      image: "/placeholder.svg?height=180&width=180&text=Cepillo+Bambú",
      discount: 20,
      installments: 6,
      freeShipping: true,
      rating: 4,
